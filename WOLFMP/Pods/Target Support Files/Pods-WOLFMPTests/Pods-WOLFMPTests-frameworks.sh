...
install_framework()
{
  local source="${BUILT_PRODUCTS_DIR}/Pods-WOLFMPTests/$1"
...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework 'SwiftDictModel.framework'
  install_framework 'SwiftFilePath.framework'
  install_framework 'SwiftOverlays.framework'
  install_framework 'SwiftyJSON.framework'
  install_framework 'ToastSwift.framework'
fi
